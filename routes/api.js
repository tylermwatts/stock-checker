        ...
        if (Array.isArray(query.stock)){
          ...
          try {
            ...
            if (!stock){
              ...
              res.json({stockData: {stock: createdStock.stock, price: createdStock.price, likes: createdStock.likes}})
            } else {
              ...
              res.json({stockData: {stock: stock.stock, price: stock.price, likes: stock.likes}})
            }
          })
